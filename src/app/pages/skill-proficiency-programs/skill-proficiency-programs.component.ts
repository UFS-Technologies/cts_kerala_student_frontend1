...
@Component({
  selector: 'app-skill-proficiency-programs',
  templateUrl: './skill-proficiency-programs.component.html',
  styleUrls: ['./skill-proficiency-programs.component.css']
})
export class SkillProficiencyProgramsComponent implements OnInit {
