...
@Component({
selector: 'app-Online_Verification',
templateUrl: './Online_Verification.component.html',
styleUrls: ['./Online_Verification.component.css']
})
export class Online_VerificationComponent implements OnInit {
