...
@Component({
  selector: 'app-skill-identity-programs',
  templateUrl: './skill-identity-programs.component.html',
  styleUrls: ['./skill-identity-programs.component.css']
})
export class SkillIdentityProgramsComponent implements OnInit {
