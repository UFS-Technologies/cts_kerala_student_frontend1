...
@Component({
selector: 'app-Skill_Diploma',
templateUrl: './Skill_Diploma.component.html',
styleUrls: ['./Skill_Diploma.component.css']
})
export class Skill_DiplomaComponent implements OnInit {
