...
@Component({
selector: 'app-New_Centre_Registration',
templateUrl: './New_Centre_Registration.component.html',
styleUrls: ['./New_Centre_Registration.component.css']
})
export class New_Centre_RegistrationComponent implements OnInit {
