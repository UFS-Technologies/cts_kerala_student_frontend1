...
@Component({
selector: 'app-Student_Login',
templateUrl: './Student_Login.component.html',
styleUrls: ['./Student_Login.component.css']
})
export class Student_LoginComponent implements OnInit {
...
loginsection_view:boolean=true;
Createaccount_View:boolean=true;
...
ngOnInit() {
  ...
  this.loginsection_view=false;
  this.Createaccount_View=false;
