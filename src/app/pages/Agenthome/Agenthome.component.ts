...
if(this.Course_Name!=undefined)
  ...
  this.CandidateService.Public_Search_Course(Level_Detail_Id, Country_Id, Intake_Id, course_Name_Temp,Status_Selection,Duration_Selection,Ielts_Id,this.Page_Start,this.Page_End,this.Page_Length).subscribe(Rows => {
  
     this.router.navigate(['home'], { queryParams: { Level: Level_Detail_Id, Country: Country_Id, Intake: Intake_Id, Course: course_Name_Temp, Status: Status_Selection, Duration: Duration_Selection, Ielts: Ielts_Id, Page_Start: this.Page_Start, Page_End: this.Page_End, Page_Length: this.Page_Length} })
