...
@Component({
selector: 'app-C_Tech_Skill_Training_Centres',
templateUrl: './C_Tech_Skill_Training_Centres.component.html',
styleUrls: ['./C_Tech_Skill_Training_Centres.component.css']
})
export class C_Tech_Skill_Training_CentresComponent implements OnInit {
