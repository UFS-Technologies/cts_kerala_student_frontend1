...
@Component({
  selector: 'app-university-program',
  templateUrl: './university-program.component.html',
  styleUrls: ['./university-program.component.css']
})
export class UniversityProgramComponent implements OnInit {
